...
[![](https://img.shields.io/github/workflow/status/sguerri/ppass/Build/v1.3.3)](https://github.com/sguerri/ppass/actions/workflows/build.yml)
...
```bash
sudo dpkg -i ppass_1.3.3_{{os}}_amd64.deb
```
