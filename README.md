...
[![](https://img.shields.io/github/workflow/status/sguerri/ppass/Build/v1.2.2)](https://github.com/sguerri/ppass/actions/workflows/build.yml)
...
```bash
sudo dpkg -i ppass_1.2.2_{{os}}_amd64.deb
```
