...
[![](https://img.shields.io/github/workflow/status/sguerri/ppass/Build/v1.1.5)](https://github.com/sguerri/ppass/actions/workflows/build.yml)
...
```bash
sudo dpkg -i ppass_1.1.5_{{os}}_amd64.deb
```
